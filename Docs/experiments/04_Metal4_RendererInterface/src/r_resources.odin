...
r_get_mesh :: proc(handle: R_Mesh_Handle) -> (mesh: ^R_Mesh, ok: bool) #optional_ok {
...
r_get_material :: proc(handle: R_Material_Handle) -> (material: ^R_Material, ok: bool) #optional_ok {
	if r_is_resource_valid(handle) {
